...
int main()
{
	HANDLE hReader[READ_COUNT];
	DWORD   dwReadThreadIdArray[READ_COUNT];
	LPVOID pReadData[READ_COUNT];

	HANDLE hWriter[WRITE_COUNT];
	DWORD   dwWriteThreadIdArray[WRITE_COUNT];
	LPVOID pWriteData[WRITE_COUNT];
